...
| **showIcon**              | _Bool_         | true                            | Show or hide icon                                                                           |
| **setIcon**               | _String_       | chevron-down                    | Set custom icon                                                           				     |
| **setIconSize**           | _Int_          | 24                          	   | Set custom icon size                                                              			 |
| **selectedText**          | _Bool/String_  | false                           | Set custom selected text when multiples selected use %t to replace by total selected        |
