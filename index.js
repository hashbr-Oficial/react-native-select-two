...
class Select2 extends Component {
    ...
    renderItem = ({ item, idx }) => {
        ...
        let key = isSelectSingle ? idx : idx[0];
        return (
            <TouchableOpacity
                key={key}
    ...
    render() {
        let {
            ...
            selectedTitleStyle, buttonTextStyle, buttonStyle, showSearchBox, showIcon, setIcon, setIconSize, selectedText
        } = this.props;
            ...
            <TouchableOpacity
                ...
                {showIcon == true && (
                    <View style={{ alignItems: 'flex-end', alignContent: 'flex-end' }}>
                        <Entypo name={setIcon} size={setIconSize} color="#6e6e6e" />
                    </View>
                )}
            </TouchableOpacity>
        );
